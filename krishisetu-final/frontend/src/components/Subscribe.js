...
// import slide3 from '../assets/morning.jpg'; // Replace with actual image
...
const Subscribe = () => {
  ...
  const fetchWalletData = useCallback(async () => {
    ...
    try {
      ...
      const balance = safeParseNumber(balanceData.balance);
      
      // Ensure all transaction amounts are numbers
      const processedTransactions = transactionsData.transactions.map(txn => ({
        ...txn,
  ...
  useEffect(() => {
    fetchSubscriptions();
    fetchWalletData();
  }, [fetchSubscriptions, fetchWalletData]);
        ...
        <Slider {...carouselSettings}>
          <div className="carousel-slide">
            ...
            <div className="slide-overlay">
              ...
              <p>Enjoy free delivery on all your subscription orders</p>
            </div>
          </div>
          <div className="carousel-slide">
            <img src="/images/discount.jpg" alt="5% Discount" />
            <div className="slide-overlay">
              <h3>5% Discount</h3>
              <p>Get 5% discount on every product in your subscription</p>
            </div>
          </div>
        </Slider>
      </div>
