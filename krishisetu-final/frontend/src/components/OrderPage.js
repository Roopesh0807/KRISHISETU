...
//         addr => addr.id === selectedRecipientAddress
//       );
//       orderData.recipient_name = selectedRecipient.name;
//       orderData.recipient_phone = selectedRecipient.phone;
//       orderData.address = selectedRecipient.address;
//     } else {
//       orderData.address = consumerprofile.address;
//     }
...
//     const options = {
//       key: process.env.REACT_APP_RAZORPAY_KEY_ID || 'rzp_test_YOUR_KEY_ID', // Fallback for testing
            ...
            <div key={product.product_id} className="krishi-order-item">
              ...
              <div className="krishi-product-details">
                ...
                <div className="krishi-product-meta">
                  ...
                  <span className="krishi-product-quantity">{product.quantity} kg</span>
                  <span className="krishi-product-total">
                    <FaRupeeSign /> {product.price_1kg * product.quantity}
                  </span>
                </div>
        ...
        <div className="krishi-summary-section">
          <div className="krishi-coupon-card">
            ...
            <div className="krishi-coupon-input-group">
              ...
              <button onClick={applyCoupon} disabled={couponApplied} className="krishi-coupon-btn">
                {couponApplied ? "Applied" : "Apply"}
              </button>
            </div>
            {couponApplied && (
          ...
          <div className="krishi-total-card">
            ...
            <div className="razorpay-embed-btn" data-url="https://pages.razorpay.com/pl_QGSNwHvRphGTJO/view" data-text="Pay Now" data-color="#528FF0" data-size="large"></div>
          </div>
        </div>
      </div>
    </div>
