...
//       setFormData(prev => ({
//         ...prev,
//         [section]: { ...prev[section], [field]: res.data.filename }
//       }));

//       // If profile photo was uploaded, update the profile photo state
//       if (field === 'profile_photo') {
//         setProfilePhoto(`http://localhost:5000/uploads/${res.data.filename}`);
//       }
...
//   // Handle profile photo change
//   const handlePhotoChange = async (e) => {
//     await handleFileUpload('personal', 'profile_photo', e);
//   };
...
//       // Update basic info if contact number was changed in personal details
//       if (section === 'personal' && formData.personal.contact_no !== formData.basicInfo.contact_no) {
//         setFormData(prev => ({
//           ...prev,
//           basicInfo: {
//             ...prev.basicInfo,
//             contact_no: prev.personal.contact_no
//           }
//         }));
//       }
//     } catch (error) {
